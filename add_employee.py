...
class add_employee:
    ...
    def __init__(self,root):
        ...
        btn_log1=Button(addemp_frame1,text="Dashboard",command=self.disp_dashboard,height=1,width=10,font=("arial",16,"bold"),bg="lightgray",fg="black").grid(row=3,column=0,pady=0)
...
#        txt_city=Entry(addemp_frame,bd=2,width=20, textvariable=self.address, relief=GROOVE,font=("",12)).grid(row=11,column=1,padx=20)
        ...
        lbl_add=Label(addemp_frame,text="City",font=("times new roman",16,"bold"))
        ...
        btn_clear= Button(addemp_frame,text = "Reset",command=self.reset, width=15,font=("times new roman",14,"bold"),bg="yellow",fg="red").place(x=40,y=470,width=100)
